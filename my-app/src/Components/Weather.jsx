  ...
  return (
    <div className='layout'>
        <div>
             ...
             <div className='search_lay'>
                 <input type="text" placeholder='City' className='search' onChange={handleChange} style={{width:250, textAlign:"center"}}/>
            ...
            gotData?(
                <div>
                    ...
                    <div style={{display:"flex", "gap":"50px",width:"55%", margin:"auto"}}>
                        <div style={{border:"1px solid #FFB6C1", backgroundColor:"#FFB6C1", fontWeight:"bold", width:"33%",textAlign:"left", paddingLeft:50 , marginTop:30, borderRadius:10}}>
                        ...
                        <div>
                            <iframe style={{border:"solid #FFB6C1", color:"#ff0ed7", fontWeight:"bold", textAlign:"left",paddingTop:5, marginTop:30, height:400,width:"150%", borderRadius:10}} src={`https://www.google.com/maps/embed/v1/place?q=${weatherData.name}&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8`} title="Map"></iframe>
                        </div>   
                    </div> 
                </div>
            ):("")
        ...
        <div style={{"display":"flex", width:"80%",gap:10,margin:"auto", marginTop:50, marginBottom:50}}>
            {
                foreCast.map((el)=>(
                    <div style={{border:"1px solid red", borderRadius:10,backgroundColor:"#0AFFFF", fontWeight:"bold"}}>
                        <p>{Date(el.dt*1000)}</p>
